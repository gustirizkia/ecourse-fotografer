...
<body>
   <nav class="navbar navbar-dark navbar-expand-md sticky-top" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #fafafa), color-stop(1, #fafafa));border-bottom: 1px solid #c2c7d1;border-top: 1px solid #c2c7d1;">
    ...
    <div class="container py-4 py-xl-5">
        ...
        <div class="row">
            <div class="col mb-4">
                <div class="d-flex align-items-center"><img class="rounded-circle flex-shrink-0 mr-3 fit-cover" width="130" height="130" src="assets/img/image-profile.png">
                    <div>
        ...
        <div class="row">
            <div class="col text-center mb-4"><button class="btn" type="button" style="width:270px;background-color:#1566B1;color:#fff !important; border-radius:30px;">Upload Hasil Praktik</button></div>
        </div>
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-4 text-center"><img class="img-fluid" src="assets/img/image-1.png" style="border-radius:30px;"><img class="img-fluid icon-check" src="assets/img/check.png"></div>
            <div class="col-sm-12 col-md-6 col-lg-4 text-center"><img class="img-fluid" src="assets/img/image-1.png" style="border-radius:30px;"><img class="img-fluid icon-check" src="assets/img/uncheck.png"></div>
            <div class="col-sm-12 col-md-6 col-lg-4 text-center"><img class="img-fluid" src="assets/img/image-1.png" style="border-radius:30px;"><img class="img-fluid icon-check" src="assets/img/check.png"></div>
            <div class="col-sm-12 col-md-6 col-lg-4 text-center"><img class="img-fluid" src="assets/img/image-1.png" style="border-radius:30px;"><img class="img-fluid icon-check" src="assets/img/check.png"></div>
            <div class="col-sm-12 col-md-6 col-lg-4 text-center"><img class="img-fluid" src="assets/img/image-1.png" style="border-radius:30px;"><img class="img-fluid icon-check" src="assets/img/check.png"></div>
            <div class="col-sm-12 col-md-6 col-lg-4 text-center"><img class="img-fluid" src="assets/img/image-1.png" style="border-radius:30px;"><img class="img-fluid icon-check" src="assets/img/check.png"></div>
