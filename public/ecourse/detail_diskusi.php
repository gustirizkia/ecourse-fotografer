    ...
    <section>
        <div class="container">
            ...
            <div class="bg-white border-white shadow pl-3 pt-3 pr-3" style="padding-bottom:60px; border-radius:20px;margin-bottom:30px;">
                <div class="row">
                    <div class="col mb-4">
                        <div class="d-flex float-left align-items-center"><img class="rounded-circle flex-shrink-0 mr-3 fit-cover" width="30" height="30" src="assets/img/image-profile.png">
                            <div>
                                <h5 class="font-weight-bold text-dark mb-0">Arie Aprizal</h5>
                            </div>
                        </div>
                        <p class="text-muted float-right">27/06/22</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <h5 class="font-weight-bold mb-2">Rekomendasi Kamera yang cocok digunakan untuk pemula?</h5>
                        <p class="text-black-50 mb-0"><span style="color: rgb(0, 0, 0);">Lorem Ipsum&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</span><br></p>
                ...
                <div class="row">
                    <div class="col text-center"><a class="btn btn-light button-comment" role="button" href="membuat_diskusi.html">Comment&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<i class="fa fa-plus"></i></a></div>
                </div>
            </div>
        </div>
    </section>
