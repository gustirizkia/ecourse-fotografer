                    ...
                    @foreach ($items as $key => $item)
                        ...
                        <div class="card card-accordion-L">
                            <div class="card-header card-header-accordion-L" role="tab">
                                <h6 class="mb-0"><i class="fa fa-leaf icon-accordion"></i><a data-toggle="collapse" aria-expanded="false" aria-controls="accordion-1 .item-1" href="#accordion-1 .item-1" class="button-accordion">{{ $key }}</a><i class="fa fa-caret-down float-right" style="color: #938d76;"></i></h6>
                            </div>
                            <div class="collapse item-1 collapse-show-item-accordion-L show" role="tabpanel" data-parent="#accordion-1">
                                <div class="card-body card-body-sidebar">
                                    <ul class="list-unstyled">
                                        @foreach ($item as $materi)
                                        <li class="mt-2" ><a href="{{ route('course', 'id='.$materi->id) }}">{{ $materi->judul }}</a></li>
                                        @endforeach
            ...
            <div class="container-fluid py-4 py-xl-5">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h2 class="font-weight-bold">{{ $detail_item->judul }}</h2>
                    </div>
                </div>
                    @if ($detail_item->video)
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" src="{{ asset('storage/'.$detail_item->video) }}" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    @endif
                    @if ($detail_item->image)
                        <div class="row mb-5 justify-content-center">
                            <div class="col-md-8">
                                <img src="{{ asset('storage/'.$detail_item->image) }}" alt="" class="img-fulid w-100">
                            </div>
                        </div>
                    @endif
                    <div class="row">
